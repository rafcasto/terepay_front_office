...
export function useOnboardingPersistence() {
  ...
  }, [user, authLoading, hasInitialized, loadFromStorage, loadStep1FromBackend,loadStep2FromBackend,loadStep3FromBackend,loadStep4FromBackend,loadStep5FromBackend,loadStep6FromBackend]);
